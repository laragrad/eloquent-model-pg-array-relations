...
class HasManyInArray extends PgArrayRelation
{
    ...
    public function attach($ids, $touch = true)
    {
        if (!is_null($ids)) {
            ...
            $this->parent
                ->setAttribute(
                    $this->arrayField,
                    array_values(array_unique(array_merge($val, $ids)))
                )
                ->save();
        }
    ...
    public function detach($ids = null, $touch = true)
    {
        if (!is_null($ids)) {
            ...
            $this->parent
                ->setAttribute($this->arrayField, array_values(array_unique(array_diff($val, $ids))))
                ->save();
        }
